...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2022 at 07:42 AM
...
INSERT INTO `addmin` (`id`, `username`, `password`) VALUES
(1, 'admin1', '$2y$10$52fyuIWODdVOa56QqA/IoOiTzS1WtZ15dxkxeCfGX8MbdbR/JxE6u');
...
(1, 'Kaos Sudirman', 1, 60000, 12, 'Pcs', '8.jpg', 'Bahan cvc bandung build up tanpa jahitan samping', 'Y'),
(2, 'Kaos Skaters', 1, 65000, 24, 'Pcs', '1.jpg', 'Bahan Cotton Combed 24s built up', 'Y'),
(3, 'Kaos Emwe', 1, 80000, 30, 'Pcs', '2.jpg', 'Bahan cvc bandung build up tanpa jahitan samping', 'Y'),
(4, 'Kaos Begin', 1, 80000, 20, 'Pcs', '3.jpg', 'Bahan cvc bandung build up tanpa jahitan samping', 'Y'),
(5, 'Kaos Man City', 1, 60000, 30, 'Pcs', '4.jpg', 'Bahan Cotton Combed 20s Jahitan samping', 'Y'),
(6, 'Kaos H & L', 1, 75000, 20, 'Pcs', '5.jpg', 'Bahan Cotton Combed 24s built up', 'Y'),
(7, 'Kaos Cool Blue', 1, 70000, 20, 'Pcs', '6.jpg', 'Bahan kardet jakarta', 'Y'),
(8, 'Kaos Feed Me', 1, 65000, 12, 'Pcs', '7.jpg', 'Bahan Cotton Combed 24s built up', 'Y'),
(9, 'Kaos Art Hitam', 1, 55000, 20, 'Pcs', '98.jpg', 'Bahan cvc bandung build up tanpa jahitan samping', 'Y'),
(24, 'gucci', 1, 200000, 4, '1', 'Kimono.jpg', 'ready', 'y');
...
(21, '60200120038', '$2y$10$1eDhsmRjbpsRPlRrR9Ll2e9nn08VZAGNtEsG7k9tvKOhQ2vF0buJ2'),
(22, 'admin', '$2y$10$ekvVARYa7CvOeAtu8hdK/.ZKLzkDVHJs93dxe2iuloZMEFbttkS4K');
...
--
ALTER TABLE `barang`
  MODIFY `br_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
